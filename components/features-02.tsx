      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-16 md:pt-32">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Custom AI Solutions</h2>
            <p className="text-lg text-slate-400">We specialize in developing tailored AI agents and workflows that transform how your business operates. Our solutions are designed to automate complex tasks, enhance decision-making, and drive operational efficiency.</p>
          </div>
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8 md:pr-0">
                        <div className="mb-5">
                          <div>
                            <h3 className="inline-flex text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">AI Integration</h3>
                            <p className="text-slate-400">We help businesses seamlessly integrate AI agents into their existing workflows. Our solutions are built with security, scalability, and performance in mind, ensuring smooth adoption across your organization.</p>
                          </div>
                        </div>
                        <div>
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          <h3 className="inline-flex text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">AI Workflow Automation</h3>
                          <p className="text-slate-400">Transform your business processes with intelligent automation powered by cutting-edge AI technology.</p>
                        </div>
                      </div>
                      {/* Image */}
                ...
                <HighlighterItem>
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          <h3 className="inline-flex text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">Natural Language Processing</h3>
                          <p className="text-slate-400">Advanced NLP capabilities for human-like interactions and text understanding.</p>
                        </div>
                      </div>
                      {/* Image */}
                      <div className="relative w-full h-64 md:h-auto overflow-hidden md:pb-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">LLM Fine-Tuning</h4>
              </div>
              <p className="text-sm text-slate-400">Custom LLM models tailored to your specific business needs and data.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Process Automation</h4>
              </div>
              <p className="text-sm text-slate-400">End-to-end automation of complex business workflows using AI agents.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
              ...
              <p className="text-sm text-slate-400">Upgradable custom solutions, keeping in-line with business needs.</p>
            </div>
            {/* Feature */}
            {/* <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Agentic</h4>
              </div>
